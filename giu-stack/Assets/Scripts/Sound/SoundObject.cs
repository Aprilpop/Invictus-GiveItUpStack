...
public class SoundObject : MonoBehaviour
{
	...
	public void ObjUpdate()
	{
		...
		*/
		...
		/*if(PanWithScreen && CameraManager.Instance && CameraManager.Instance.Camera)
		{
			float half = Screen.width / 2;
			Pan = (CameraManager.Instance.Camera.WorldToScreenPoint(transform.position).x - half) / half;
